...
contract ContractTest is Test {
    ...
    function executeOperation(address sender, address underlying, uint256 amount, uint256 fee, bytes calldata params)
        external
    {
    ...
    function onFlashLoan(address initiator, uint256[] calldata amounts, uint256[] calldata fees, bytes calldata data)
        external
    {
